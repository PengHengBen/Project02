...
//            System.out.println("catch - 传递的文件后缀不是.txt");
            ...
            /*
                Throwable类中定义了3个异常处理的方法
                    ...
                    String toString() 返回此 throwable 的详细信息字符串 默认此方法
...
//            System.out.println(e); // java.io.IOException: 文件的后缀名不对
            ...
            /*
                java.io.IOException: 文件的后缀名不对
                    at com.itheima.demo02.Exception.Demo01TryCatch.readFile(Demo01TryCatch.java:59)
                    at com.itheima.demo02.Exception.Demo01TryCatch.main(Demo01TryCatch.java:32)
             */
            e.printStackTrace();
        }
